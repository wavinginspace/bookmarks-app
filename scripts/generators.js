...
<section class="add-bookmark-view">
  ...
  <form id="add-new-bookmark-form" autocomplete="off">
    ...
    <label aria-label="new-bookmark-rating" class="new-bookmark-label" for="new-bookmark-rating">Add bookmark rating (1-5):</label>

    <input type="number" class="rating" size="3" min="1" max="5" name="url" placeholder="3" id="new-bookmark-rating" required>
