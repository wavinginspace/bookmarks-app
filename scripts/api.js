...
const listApiFetch = function (...args) {
  ...
  return fetch(...args)
    ...
    .then(data => {
      // if error exists, place the JSON message into the error object and reject the Promise with your error object so it lands in the next catch. IMPORTANT: Check how the API sends errors -- not all APIs will respond with a JSON object containing message key.
      if (error) {
